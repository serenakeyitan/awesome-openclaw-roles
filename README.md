...
Existing awesome lists organize skills by technical category. This one organizes by **who you are** — so you can grab a role-ready toolkit in seconds.

**Legend:** 🇨🇳 = China-market specific
...
*Run campaigns, track brand presence, and grow audiences with AI-powered marketing automation.*
...
*Ship code faster with skills for version control, CI/CD, full-stack scaffolding, and infrastructure.*
...
*Track markets, extract financial data, analyze business metrics, and automate reporting.*
...
- **[Amplitude Automation](https://github.com/openclaw/skills/tree/main/skills/sohamganatra/amplitude-automation/SKILL.md)** - Automate Amplitude product analytics tasks — event tracking, funnels, and cohort reports.
...
- **[Data Enricher](https://github.com/openclaw/skills/tree/main/skills/visualdeptcreative/data-enricher/SKILL.md)** - Enrich lead datasets with email addresses, company info, and formatted output.
...
*Design interfaces, audit UX, generate assets, and build production-ready design systems.*

- **[UI/UX Master](https://clawhub.ai/wanng-ide/ui-ux-master)** - Apple HIG + modern web design principles for building intuitive interfaces.
...
- **[Frontend Design](https://github.com/kesslerio/ultimate-frontend-design-openclaw-skill)** - Production-grade frontend with React, Tailwind, and shadcn/ui for design implementation.

## 🤝 Sales / BD

*Prospect leads, manage CRM pipelines, automate outreach, and close deals faster.*
...
*Manage email, calendars, notes, reminders, and day-to-day workplace productivity.*
...
*Search the web, synthesize papers, build knowledge graphs, and automate deep research workflows.*
...
- **[Aliyun ASR](https://github.com/openclaw/skills/tree/main/skills/jixsonwang/aliyun-asr/SKILL.md)** 🇨🇳 - Voice message transcription via Aliyun ASR for converting lectures and interviews to text.
...
2. **Format:** `- **[Skill Name](link)** - One-line description ending with a period.`
3. **Role assignment** — put the skill under its **primary** role. If it genuinely serves 2+ roles, duplicate it with role-specific descriptions.
